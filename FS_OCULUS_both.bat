...
@CMD /C START /B /ABOVENORMAL "" /D "C:\Program Files\Oculus\Support\oculus-client" "C:\Program Files\Oculus\Support\oculus-client\OculusClient.exe"
...
copy F:\My_FS_community\panelsVR\webserver\root\files\charts\*.* F:\My_FS_community\panelsVR\webserver\root\files\*.*
if exist "F:\My_FS_community\panelsVR\webserver\root\files\c172\parametros_fs.txt" (
    copy "F:\My_FS_community\panelsVR\webserver\root\files\c172\parametros_fs.txt" "C:\Scripts\parametros_fs.txt"
)
goto afterFdoc
:Fdoc2
del /F /Q F:\My_FS_community\panelsVR\webserver\root\files\*.*
...
copy F:\My_FS_community\panelsVR\webserver\root\files\charts\*.* F:\My_FS_community\panelsVR\webserver\root\files\*.*
if exist "F:\My_FS_community\panelsVR\webserver\root\files\c310\parametros_fs.txt" (
    copy "F:\My_FS_community\panelsVR\webserver\root\files\c310\parametros_fs.txt" "C:\Scripts\parametros_fs.txt"
)
goto afterFdoc
:Fdoc3
del /F /Q F:\My_FS_community\panelsVR\webserver\root\files\*.*
...
copy F:\My_FS_community\panelsVR\webserver\root\files\charts\*.* F:\My_FS_community\panelsVR\webserver\root\files\*.*
if exist "F:\My_FS_community\panelsVR\webserver\root\files\xcub\parametros_fs.txt" (
    copy "F:\My_FS_community\panelsVR\webserver\root\files\xcub\parametros_fs.txt" "C:\Scripts\parametros_fs.txt"
)
goto afterFdoc
:Fdoc4
del /F /Q F:\My_FS_community\panelsVR\webserver\root\files\*.*
...
copy F:\My_FS_community\panelsVR\webserver\root\files\charts\*.* F:\My_FS_community\panelsVR\webserver\root\files\*.*
if exist "F:\My_FS_community\panelsVR\webserver\root\files\pmdg737\parametros_fs.txt" (
    copy "F:\My_FS_community\panelsVR\webserver\root\files\pmdg737\parametros_fs.txt" "C:\Scripts\parametros_fs.txt"
)
goto afterFdoc
:afterFdoc
del /F /Q F:\My_FS_community\panelsVR\webserver\root\files\parametros_fs.txt
CLS
...
goto afterNetwork
:doIvao
@CMD /C START /B /BELOWNORMAL "" /D "f:\antimicro-2.23-win32.portable\antimicro" "F:\antimicro-2.23-win32.portable\antimicro\antimicro.exe"
@CMD /C START /B /BELOWNORMAL "" /D "F:\MSFS2020\IVAO\PilotCore" "F:\MSFS2020\IVAO\PilotCore\pilot_core_fs2020.exe"
@CMD /C START /B /BELOWNORMAL "" /D "F:\MSFS2020\IVAO\PilotUI" "F:\MSFS2020\IVAO\PilotUI\PilotUI.exe"
wmic process where name="antimicro.exe" CALL setpriority "below normal"
wmic process where name="pilot_core_fs2020.exe" CALL setpriority "below normal"
wmic process where name="PilotUI.exe" CALL setpriority "below normal"
goto afterNetwork

:doVatsim
@CMD /C START /B /BELOWNORMAL "" /D "C:\Users\eaide\AppData\Local\vPilot" "C:\Users\eaide\AppData\Local\vPilot\vPilot.exe"
@CMD /C START /B /BELOWNORMAL "" /D "F:\My_FS_community\panelsVR\vs-radio-toolbar\server" "F:\My_FS_community\panelsVR\vs-radio-toolbar\server\VSR.exe" 2> nul
